...
def main():
    ...
    usd_path='examples/isaac_sim/vkc_door.usd'
    prim_path='/door'
    stage.DefinePrim("/door", "Xform") 
    usd_help.load_stage(my_world.stage)
    prim = stage.GetPrimAtPath(prim_path)
    prim.GetReferences().AddReference(usd_path)
    # add_reference_to_stage(usd_path=usd_path, prim_path=prim_path)
    # set_prim_transform(stage.GetPrimAtPath(prim_path), [1.5, 0.5, 0, 1,0, 0, 0])


    # set_prim_transform(stage.GetPrimAtPath('/World/target'), [1.5, 0, 0, 1,0, 0, 0])
    # create_prim(prim_path=prim_path,usd_path=usd_path,prim_type="Xform",position=np.array([2.0, 2.5, 0.0]))
   
    # world_cfg1 = usd_help.get_obstacles_from_stage(
    ...
    # usd_help.add_world_to_stage(world_cfg1, base_frame="/World")
