...
def main():
    ...
    #     color=np.array([1.0, 0, 0]),
    #     size=0.05,
    #     linear_velocity=[0.0, 1e-10, 0.0],  # 设置线速度
    #     # angular_velocity=[0.0, 0.0, 1.0],  # 设置角速度
    # )
    ...
    Position=np.array([0.9244956,0.4325445,0.96])
    Orientations=np.array([ 4.1981271e-04,-4.1981271e-04 ,9.9842656e-01,-5.6072213e-02])
    target.set_world_pose(position=Position, orientation=Orientations)
    ...
    while simulation_app.is_running():
        ...
        #     target_pose = cube_position
        # print(cube_position,target_pose)
        ...
        if (
            ...
            if succ:
                ...
                Position=np.random.normal(0.8,0.2,3)
                Orientations=np.array([ 4.1981271e-04,-4.1981271e-04 ,9.9842656e-01,-5.6072213e-02])
                target.set_world_pose(position=Position, orientation=Orientations)
                for i in target_links.keys():
                    if i=="panda2_hand":
                        # Position2=np.random.normal(-0.5,1,3)
                        Position_x=np.random.normal(-0.6,0.2,1)
                        Position_y=np.random.normal(0.75,0.2,1)
                        Position_z=np.random.normal(0.6,0.2,1)
                        Position2=np.concatenate((Position_x,Position_y,Position_z),axis=0)

                    
                        target_links[i].set_world_pose(position=Position2, orientation=Orientations)
                    if i=="panda3_hand":
                        Position_x=np.random.normal(0,0.2,1)
                        Position_y=np.random.normal(-0.7,0.2,1)
                        Position_z=np.random.normal(0.6,0.2,1)
                        Position3=np.concatenate((Position_x,Position_y,Position_z),axis=0)
                        # Orientations=np.array([4.1981271e-04,-4.1981271e-04 ,9.9842656e-01,-5.6072213e-02])
                        target_links[i].set_world_pose(position=Position3, orientation=Orientations)
