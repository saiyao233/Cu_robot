...
parser.add_argument("--robot", type=str, default="dual_ur10e.yml", help="robot configuration to load")
parser.add_argument(
    "--external_asset_path",
    type=str,
    default=None,
...
def main():
    ...
    while simulation_app.is_running():
        ...
        # print('c_p',c_p)
        # print('l_p',link_target_pose)
        # print('l_pp',link_past_pose)
        ...
        if link_past_pose is None:
            link_past_pose=c_p
        if link_target_pose is None:
            link_target_pose=c_p
        ...
        if (
            ...
            or (
                np.linalg.norm(c_p - link_target_pose) > 1e-3
                and np.linalg.norm(link_past_pose - c_p) == 0.0
            )
            and robot_static
        ):
            ...
            result = motion_gen.plan_single(cu_js.unsqueeze(0), ik_goal, plan_config,link_poses=link_poses)
