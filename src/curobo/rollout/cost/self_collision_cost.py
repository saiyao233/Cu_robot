...
class SelfCollisionCost(CostBase, SelfCollisionCostConfig):
    ...
    def forward(self, robot_spheres):
        ...
        # print('1',robot_spheres)
        # print('distance',self._out_distance)
        # print('1',self._out_distance)
        # print('2',self._out_vec.shape)
        # print('3',self._out_vec)
        # print('4',self._sparse_sphere_idx.shape)
        # print('5',self._sparse_sphere_idx)
        # print('6',self.return_loss)
