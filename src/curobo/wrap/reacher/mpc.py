...
class MpcSolver(MpcSolverConfig):
    ...
    def step(
        ...
        # shift_steps 通常用于表示在预测模型中向前看的步数
        shift_steps: int = 1,
        seed_traj: Optional[JointState] = None,
        max_attempts: int = 1,
    ):
        converged = True
        # print("seed_traj", seed_traj)
    ...
    def step_once(
        ...
        if self.use_cuda_graph_full_step:
            ...
            # print("self._step_goal_buffer", self._step_goal_buffer)
